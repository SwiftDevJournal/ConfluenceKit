...
extension Paths.Databases.WithID {
    ...
    public struct Properties {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getDatabaseContentProperties")
        }
        ...
        public func post(_ body: ConfluenceKit.ContentPropertyCreateRequest) -> Request<ConfluenceKit.ContentProperty> {
            Request(path: path, method: "POST", body: body, id: "createDatabaseProperty")
        }
    }
}
