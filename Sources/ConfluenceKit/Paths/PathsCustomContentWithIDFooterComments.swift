...
extension Paths.CustomContent.WithID {
    ...
    public struct FooterComments {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getCustomContentComments")
        }

        /// MultiEntityResult<CustomContentCommentModel>
        public struct GetResponse: Decodable {
            public var results: [ConfluenceKit.CustomContentCommentModel]?
            public var links: ConfluenceKit.MultiEntityLinks?

            public init(results: [ConfluenceKit.CustomContentCommentModel]? = nil, links: ConfluenceKit.MultiEntityLinks? = nil) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.results = try values.decodeIfPresent([ConfluenceKit.CustomContentCommentModel].self, forKey: "results")
