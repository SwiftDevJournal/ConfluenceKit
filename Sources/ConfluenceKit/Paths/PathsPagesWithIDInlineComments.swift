...
extension Paths.Pages.WithID {
    ...
    public struct InlineComments {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getPageInlineComments")
        }

        /// MultiEntityResult<PageInlineCommentModel>
        public struct GetResponse: Decodable {
            public var results: [ConfluenceKit.PageInlineCommentModel]?
            public var links: ConfluenceKit.MultiEntityLinks?

            public init(results: [ConfluenceKit.PageInlineCommentModel]? = nil, links: ConfluenceKit.MultiEntityLinks? = nil) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.results = try values.decodeIfPresent([ConfluenceKit.PageInlineCommentModel].self, forKey: "results")
