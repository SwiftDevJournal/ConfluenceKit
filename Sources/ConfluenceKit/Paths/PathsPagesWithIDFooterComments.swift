...
extension Paths.Pages.WithID {
    ...
    public struct FooterComments {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getPageFooterComments")
        }

        /// MultiEntityResult<PageCommentModel>
        public struct GetResponse: Decodable {
            public var results: [ConfluenceKit.PageCommentModel]?
            public var links: ConfluenceKit.MultiEntityLinks?

            public init(results: [ConfluenceKit.PageCommentModel]? = nil, links: ConfluenceKit.MultiEntityLinks? = nil) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.results = try values.decodeIfPresent([ConfluenceKit.PageCommentModel].self, forKey: "results")
