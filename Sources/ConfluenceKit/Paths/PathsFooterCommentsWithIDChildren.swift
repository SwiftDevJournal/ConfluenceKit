...
extension Paths.FooterComments.WithID {
    ...
    public struct Children {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getFooterCommentChildren")
        }

        /// MultiEntityResult<ChildrenCommentModel>
        public struct GetResponse: Decodable {
            public var results: [ConfluenceKit.ChildrenCommentModel]?
            public var links: ConfluenceKit.MultiEntityLinks?

            public init(results: [ConfluenceKit.ChildrenCommentModel]? = nil, links: ConfluenceKit.MultiEntityLinks? = nil) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.results = try values.decodeIfPresent([ConfluenceKit.ChildrenCommentModel].self, forKey: "results")
