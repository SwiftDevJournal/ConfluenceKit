...
extension Paths.FooterComments.WithID {
    ...
    public struct Versions {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getFooterCommentVersions")
        }

        /// MultiEntityResult<Version>
        public struct GetResponse: Decodable {
            public var results: [ConfluenceKit.CommentVersion]?
            public var links: ConfluenceKit.MultiEntityLinks?

            public init(results: [ConfluenceKit.CommentVersion]? = nil, links: ConfluenceKit.MultiEntityLinks? = nil) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.results = try values.decodeIfPresent([ConfluenceKit.CommentVersion].self, forKey: "results")
