...
extension Paths.Pages.WithID {
    ...
    public struct Children {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getChildPages")
        }

        /// MultiEntityResult<ChildPage>
        public struct GetResponse: Decodable {
            public var results: [ConfluenceKit.ChildPage]?
            public var links: ConfluenceKit.MultiEntityLinks?

            public init(results: [ConfluenceKit.ChildPage]? = nil, links: ConfluenceKit.MultiEntityLinks? = nil) {
            ...
            public init(from decoder: Decoder) throws {
                ...
                self.results = try values.decodeIfPresent([ConfluenceKit.ChildPage].self, forKey: "results")
