...
extension Paths.CustomContent.WithCustomContentID {
    ...
    public struct Properties {
        ...
        public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
            Request(path: path, method: "GET", query: parameters?.asQuery, id: "getCustomContentContentProperties")
        }
        ...
        public func post(_ body: ConfluenceKit.ContentPropertyCreateRequest) -> Request<ConfluenceKit.ContentProperty> {
            Request(path: path, method: "POST", body: body, id: "createCustomContentProperty")
        }
    }
}
