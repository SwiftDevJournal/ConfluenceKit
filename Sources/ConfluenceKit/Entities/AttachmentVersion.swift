...
public struct AttachmentVersion: Codable {
    ...
    public init(createdAt: Date? = nil, message: String? = nil, number: Int32? = nil, isMinorEdit: Bool? = nil, authorID: String? = nil, attachment: VersionedEntity? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.attachment = try values.decodeIfPresent(VersionedEntity.self, forKey: "attachment")
    }
