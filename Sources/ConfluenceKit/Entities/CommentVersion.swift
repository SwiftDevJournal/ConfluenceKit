...
public struct CommentVersion: Codable {
    ...
    public var comment: VersionedEntity?

    public init(createdAt: Date? = nil, message: String? = nil, number: Int32? = nil, isMinorEdit: Bool? = nil, authorID: String? = nil, comment: VersionedEntity? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.comment = try values.decodeIfPresent(VersionedEntity.self, forKey: "comment")
    }
