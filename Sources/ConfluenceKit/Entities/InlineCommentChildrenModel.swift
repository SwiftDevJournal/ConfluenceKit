...
public struct InlineCommentChildrenModel: Codable {
    /// ID of the comment.
    ...
    public init(id: String? = nil, status: ContentStatus? = nil, title: String? = nil, parentCommentID: String? = nil, version: Version? = nil, body: BodyBulk? = nil, resolutionStatus: InlineCommentResolutionStatus? = nil, properties: InlineCommentProperties? = nil, links: CommentLinks? = nil) {
        self.id = id
        self.status = status
        self.title = title
