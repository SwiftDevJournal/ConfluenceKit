...
public struct BlogPostVersion: Codable {
    ...
    public var blogpost: VersionedEntity?

    public init(createdAt: Date? = nil, message: String? = nil, number: Int32? = nil, isMinorEdit: Bool? = nil, authorID: String? = nil, blogpost: VersionedEntity? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.blogpost = try values.decodeIfPresent(VersionedEntity.self, forKey: "blogpost")
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encodeIfPresent(blogpost, forKey: "blogpost")
    }
}
