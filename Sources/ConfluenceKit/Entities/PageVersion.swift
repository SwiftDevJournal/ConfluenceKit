...
public struct PageVersion: Codable {
    ...
    public var page: VersionedEntity?

    public init(createdAt: Date? = nil, message: String? = nil, number: Int32? = nil, isMinorEdit: Bool? = nil, authorID: String? = nil, page: VersionedEntity? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.page = try values.decodeIfPresent(VersionedEntity.self, forKey: "page")
    }
