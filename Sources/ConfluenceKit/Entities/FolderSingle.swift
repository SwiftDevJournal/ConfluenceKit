...
public struct FolderSingle: Codable {
    /// ID of the folder.
    ...
    public init(id: String? = nil, type: String? = nil, status: ContentStatus? = nil, title: String? = nil, parentID: String? = nil, parentType: ParentContentType? = nil, position: Int32? = nil, authorID: String? = nil, ownerID: String? = nil, createdAt: Date? = nil, version: Version? = nil, links: FolderLinks? = nil) {
        self.id = id
        self.type = type
        self.status = status
        self.title = title
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.links = try values.decodeIfPresent(FolderLinks.self, forKey: "_links")
    }
