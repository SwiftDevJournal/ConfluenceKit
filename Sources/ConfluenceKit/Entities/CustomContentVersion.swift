...
public struct CustomContentVersion: Codable {
    ...
    public init(createdAt: Date? = nil, message: String? = nil, number: Int32? = nil, isMinorEdit: Bool? = nil, authorID: String? = nil, custom: VersionedEntity? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.custom = try values.decodeIfPresent(VersionedEntity.self, forKey: "custom")
    }
